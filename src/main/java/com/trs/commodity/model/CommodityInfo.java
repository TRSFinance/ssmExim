...
public class CommodityInfo extends CommodityInfoKey {
    ...
    private Long changedSinceLastyear;
    ...
    public Long getChangedSinceLastyear() {
        return changedSinceLastyear;
    }

    public void setChangedSinceLastyear(Long changedSinceLastyear) {
